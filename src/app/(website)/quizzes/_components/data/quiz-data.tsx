export const quizData = [
  ...
  },
  {
    ...
    questions: [
      {
        question: "What certifications do you currently hold?",
        multiSelect: true,
        options: [
          { value: "google", text: "Google Project Management Certification" },
          {
            value: "capm",
            text: "Certified Associate in Project Management (CAPM)®",
          },
          { value: "prince2", text: "PRINCE2 Foundation" },
          { value: "csm", text: "Certified ScrumMaster (CSM)" },
          { value: "psm", text: "Professional Scrum Master (PSM I, II, III)" },
          { value: "agilepm", text: "Agile Project Management (AgilePM®)" },
          { value: "itil", text: "ITIL 4 Foundation Certification" },
          { value: "pmp", text: "Project Management Professional (PMP)®" },
          {
            value: "pmi-acp",
            text: "Agile Certified Practitioner (PMI-ACP)®",
          },
          ...
          { value: "pfmp", text: "Portfolio Management Professional (PfMP)®" },
          { value: "pgmp", text: "Program Management Professional (PgMP)®" },
          {
            value: "pmi-rmp",
            text: "Risk Management Professional (PMI-RMP)®",
          },
          { value: "cpmai", text: "Certified AI Project Manager (CPMAI)" },
          { value: "none", text: "None" },
        ],
      },
      {
        question: "What job title most closely relates to your current role?",
        options: [
          { value: "project-manager", text: "Project Manager" },
          { value: "product-manager", text: "Product Manager" },
          { value: "supply-chain-manager", text: "Supply Chain Manager" },
          { value: "program-manager", text: "Program Manager" },
          { value: "scrum-master", text: "Scrum Master" },
        ],
      },
      {
        question:
          "How many years of experience do you have in your current job role?",
        options: [
          { value: "0-1", text: "0-1 years" },
          { value: "2-3", text: "2-3 years" },
          { value: "4-5", text: "4-5 years" },
          { value: "6-7", text: "6-7 years" },
          { value: "8-9", text: "8-9 years" },
      ...
      },
      {
        ...
        options: [
          {
            value: "technology",
            text: "Technology (IT & Software Development)",
          },
          { value: "healthcare", text: "Healthcare" },
          { value: "finance", text: "Finance & Banking" },
          { value: "construction", text: "Construction & Engineering" },
          ...
          { value: "education", text: "Education & E-learning" },
          ...
          { value: "agriculture", text: "Agriculture & Food Industry" },
          { value: "realestate", text: "Real Estate & Property Management" },
        ],
      },
    ],
  },
